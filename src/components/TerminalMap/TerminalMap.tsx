...
export function TerminalMap() {
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-4 flex flex-col gap-4">
      ...
      {mapVisible && (
        <>
          <p className="text-xs text-slate-400 -mt-2">
            Click any state below to open a new terminal there, or view/upgrade an existing one.
          </p>
      ...
      {!mapVisible && (
        <p className="text-xs text-slate-500 -mt-2">Show the map to open a terminal in a new state.</p>
      )}
